                ...
                <div class="box-header">
                  ...
                  <div class="box-tools col-md-2 col-sm-2 btn-box no-padding">
                    <div class="input-group pull-right">
                     <?php if ($user_session->getRole() == 'Admin') {
                       # code...
                     ?>
                      <a href="register_class.php" type="button" class="btn btn-block btn-success btn-sm">
                    ...
                    <table id="class-list" class="table table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <tr class="center text-nowrap">
                          <td><?php echo "<a href='edit_class.php?id=" . $id . "'>" . $row . "</a>"; ?></td>
                          <td><?php echo $list[$key]['class_name']; ?></td>
                          <td><?php echo $list[$key]['teacher_name']; ?></td>
                          ...
                          <td>
                            <a class="btn btn-info" href="room.php?id=<?php echo $id; ?>" 
                            ...
                            if ($user_session->getRole() == 'Admin') {
                              # code...
                            ?>
                            <a class="btn btn-primary" href="edit_class.php?id=<?php echo $id; ?>" 
                              role="button" data-toggle="tooltip" title="Update class information.">
                              <i class="fa fa-pencil-square-o"></i>
                            </a>                             
                            <span data-toggle="tooltip" title="Delete this Class." data-placement="top">
