...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">By TRIMESTER </li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-header">
                        ...
                        <a role="button" href="outstanding_trimByLevel.php?rank_id=<?php echo $rank_id ; ?>&month=<?php echo $selectMonth ?>" class="btn btn-success btn-icon"
                                            ...
                                            foreach ($levels as $key => $value) {
                                                ...
                                                if(empty($classByLevel)){
                                                    ...
                                                    foreach ($getTrimExamScore as $number => $record) {
                                                       ...
                                                       echo '<td>
                                                            <a class="btn btn-link btn-icon" href="certi_register_outstanding.php?id='.$student->getStudentID().'&level='.$levels[$key]['level_id'].'&score='.$totalAll.'&duration='.$getMonth.'&year='.$rank->getYear().'&type=2" role="button" 
