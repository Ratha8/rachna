            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="text-center">TOP STUDENT OF THE MONTH <?php echo $rank->getRank_name() ?> BY LEVEL</h3>
                        <span class="input-group pull-right">
                             <a role="button" href="outstanding_level.php?rank_id=<?php echo $rank_id ; ?>&month=<?php echo $selectMonth ?>" class="btn btn-success btn-icon"
                                    ...
                                    <tbody>
                                        ...
                                        if ($examID == NULL) {
                                            ...
                                            foreach ($levels as $key => $value) {
                                                ...
                                                echo '<td colspan="20" class="warning" id="class"><b>' . integerToRoman($row_num) . '- ' . $levels[$key]['level_name'] . '</b></td>';
                                                if(empty($classByLevel)){
                                                    ...
                                                    elseif ($getTopScore[0]['total'] <= 68)
                                                        $mention = 'E';
                                                    elseif ($getTopScore[0]['total'] <= 78)
                                                        $mention = 'D';
                                                    elseif ($getTopScore[0]['total'] <= 85)
                                                        $mention = 'C';
                                                    elseif ($getTopScore[0]['total'] <= 94)
                                                        $mention = 'B';
                                                    elseif ($getTopScore[0]['total'] >= 95)
                                                    ...
                                                    echo "<td>" . $getTopScore[0]['total'] . "</td>";
                                                   ...
                                                   echo '<td>
                                                            <a class="btn btn-link btn-icon" href="certi_register_outstanding.php?id='.$student->getStudentID().'&level='.$levels[$key]['level_id'].'&score='.$getTopScore[0]['total'].'&duration='.$getMonth.'&year='.$rank->getYear().'&type=1" role="button" 
