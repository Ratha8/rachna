<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $teacher_query = getUserByUserID($_POST['teacher_id']);
    ...
    // $class->setRegisterUser($user_session->getUserID()); 10-07-2017
    ...
    $class->setTeacherName($teacher_query->getUsername());
    ...
    }elseif(strlen($class->getTeacherName()) >= 100){
      $st_err = 1;
      $teacher_name_err = "Teacher name must be within 100 characters long.";
    }   
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-5 col-sm-10 col-xs-10">
                        <input type="text" class="form-control" name="class_name" placeholder="Class Room Name">
                    ...
                    if($user_session->getRole() =='Admin'){?>
                      ...
                      <div class="col-md-5 col-sm-10 col-xs-10 select">
                        <!--<input type="text" class="form-control" name="teacher_name" placeholder="Teacher Name">-->
                           <select name="register_user" data-placeholder="Please select the Teacher" class="form-control chosen-select" tabindex="2">
                          <option></option>
                          <?php
                            foreach ($getrecept as $num =>$value) {
                                $selected = $getrecept[$num]['username']? "selected" : "";
                   ...
                   <?php }
                        ...
                        <select name="level_id" data-placeholder="Please select the level" class="form-control chosen-select" tabindex="2">
                          ...
                          <?php
                            foreach ($level as $key => $value) {
                              echo "<option value='" . $level[$key]['level_id'] . "'>" .
                    ...
                    <div class="form-group radio-fv">
                      <label class="col-md-1 col-sm-2 col-xs-2 control-label">Shift</label>    
                      <div class="col-md-5 col-sm-10 xs-10">
                        <div class="radio">
                          <label class="no-padding">
                            <input id="morning" name="time_shift" type="radio" class="flat-blue" value="1" checked> 
                            Morning
                          </label>
                        </div>
                        <div class="radio">
                          <label class="no-padding">
                            <input id="afternoon" name="time_shift" type="radio" class="flat-yellow" value="2"> 
                            Afternoon
                          </label>
                        </div>
                        <div class="radio">
                          <label class="no-padding">
                            <input id="evening" name="time_shift" type="radio" class="flat-red" value="3"> 
                            Evening
                          </label>
                        </div> 
