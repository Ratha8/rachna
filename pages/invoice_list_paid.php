            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <span style="float: right;"><a class="btn btn-success btn-icon" href="payment_paid.php?id=<?php echo $student->getStudentID(); ?>&room=<?php echo $student->getClassID(); ?>" role="button" data-toggle="tooltip" title="" data-original-title="Making payment for student.">
