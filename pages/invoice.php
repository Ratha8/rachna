                  ...
                  <div class="inv-header center border-bottom">
                    <h2 class="khmer">
                      ...
                      <?php if(isset($getsetting[0]['phone_number']) || !empty($getsetting[0]['phone_number'])){
                            echo '<span class="pre-contact-info">ទូរស័ព្ទ: '.$getsetting[0]['phone_number'].'</span>';
                        }else{
                            echo '<span class="pre-contact-info">ទូរស័ព្ទ: 023 64 04 955/ 010 47 57 88/ 012 47 57 88</span>';
                        }
                        ?>
                    

                    <div class="row">
                      <div class="col-md-12 col-logo-left pre-logo-inv">
