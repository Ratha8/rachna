          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF']  . '?id=' . $id; ?>" method="POST" id="courseForm">
                  <input type="hidden" name="course_id" value="<?php echo $form->getCourseID() ?>">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-md-1 col-sm-2 col-xs-2 control-label">Name</label>
                      <div class="col-md-5 col-sm-10 col-xs-10">
                        <input type="text" class="form-control" name="course_name" placeholder="Course Name" value="<?php echo $form->getCourseName(); ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-5 col-sm-10 col-xs-10">
                        <input class="form-control" type="text" name="duration" value="<?php echo $form->getDuration(); ?>">
