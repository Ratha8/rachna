                    ...
                    <div class="box-header">
                        <h3 class="text-center">TOP STUDENT OF SEMESTER <?php echo $rank->getRank_name() ?></h3>
                         <span class="input-group pull-right">
                            <a role="button" href="outstanding_sem.php?rank_id=<?php echo $rank_id ; ?>&sem=<?php echo $selectMonth ?>" class="btn btn-success btn-icon"
                                                ...
                                                if (!empty($getTSemExamScore)) {
                                                    foreach ($getTSemExamScore as $number => $record) {
                                                       ...
                                                       echo "<td>" . $student->getStudentName() . "</td>";
                                                        ...
                                                        echo '<td>
                                                            <a class="btn btn-link btn-icon" href="certi_register_outstanding.php?id='.$student->getStudentID().'&level='.$classes[$key]['level_id'].'&score='.$totalAll.'&duration='.$getMonth.'&year='.$rank->getYear().'&type=3" role="button" 
