                    ...
                    <table id="user-list" class="table table-bordered table-hover">
                      ...
                      <tbody class="text-nowrap">
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-primary btn-icon" href="edit_user.php?id=<?php echo $list[$key]['user_id']; ?>" role="button" 
                               data-toggle="tooltip" title="Edit User Information.">
                              <i class="fa fa-pencil-square-o"></i>
                            </a>
                            <span data-toggle="tooltip" title="Remove this user." data-placement="top">
                              <button class="btn btn-danger btn-icon btn-delete" data-id="<?php echo $list[$key]['user_id']; ?>" 
