...
if (isset($_GET['rank_id'])) 
    ...
    $objPHPExcel = $objReader->load("templates/outstanding_semByLevel.xls");
...
//    $objPHPExcel->getActiveSheet()->removeRow($baseRow - 1, 1);
    ...
    $filename = "outstanding_semByLevel.xls";
    $file_path = "http://" . $_SERVER['HTTP_HOST'] . "/rachana/pages/" . $filename;
//      var_dump($file_path);
    $contenttype = "application/octet-stream";
    header("Content-Type: " . $contenttype);
    header("Content-Disposition: attachment; filename=\"" . basename("outstanding_semByLevel-" . $selectMonth . ".xls") . "\";");
