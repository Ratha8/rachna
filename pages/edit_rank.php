        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <form class="form-horizontal" method="POST" id="rankForm">
                    <input type="hidden" name="rank_id" value="<?php echo $rank->getRank_id() ?>">
                    <input type="hidden" id="myYear" value="<?php echo $rank->getYear() ?>">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-10 col-xs-10">
                                    <input type="text" class="form-control" name="rank_name" value="<?php echo $rank->getRank_name() ?>" placeholder="Record Title" required>
                                </div>
                            </div>                 
                            <div class="form-group">
                                    ...
                                    <div class='input-group date'>
                                        <select name ="year" class="form-control">
                                            <script>
                                                ...
                                                var x = document.getElementById("myYear").value;
//                                                alert(x);
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-10 col-xs-10">
                                    <textarea class="form-control" placeholder="Description (optional)" name="description"><?php echo $rank->getDescription() ?></textarea>
                                </div>   
                            </div>
                        </div> 
