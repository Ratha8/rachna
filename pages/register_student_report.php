...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $student = getOneStudent($getStudentMarks->getStudent_id());
    $report->setStudentID($getStudentMarks->getStudent_id());
    $report->setMarkID($id);
                            ...
                            <div class="col-md-9 col-sm-12 col-xs-12"> 
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9 col-sm-10 col-xs-10">
                                    <input class="form-control" name="att" placeholder="Name of exam" required="" type="text" value="<?php echo $att ?>" readonly>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9 col-sm-10 col-xs-10">
                                    <input class="form-control" name="home_work" placeholder="Name of exam" required="" type="text" value="<?php echo $getStudentMarks->getHome_work(); ?>" readonly>
                                    <span class="error col-md-12 no-padding"></span>
                                    <div class="progress" id="progressBar" style="margin: 5px 0 0 0; display: none;">
                                      <div class="progress-bar progress-bar-success progress-bar-striped active" style="width: 100%"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9 col-sm-10 col-xs-10">
                                    <input class="form-control" name="class_work" placeholder="Name of exam" required="" type="text" value="<?php echo $getStudentMarks->getHome_work(); ?>" readonly>
                                    <span class="error col-md-12 no-padding"></span>
                                    <div class="progress" id="progressBar" style="margin: 5px 0 0 0; display: none;">
                                      <div class="progress-bar progress-bar-success progress-bar-striped active" style="width: 100%"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9 col-sm-10 col-xs-10">
                                    <input class="form-control" name="q1" placeholder="Name of exam" required="" type="text" value="<?php echo $getStudentMarks->getQuiz1(); ?>" readonly>
                                    <span class="error col-md-12 no-padding"></span>
                                    <div class="progress" id="progressBar" style="margin: 5px 0 0 0; display: none;">
                                      <div class="progress-bar progress-bar-success progress-bar-striped active" style="width: 100%"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9 col-sm-10 col-xs-10">
                                    <input class="form-control" name="q2" placeholder="Name of exam" required="" type="text" value="<?php echo $getStudentMarks->getQuiz2(); ?>" readonly>
                                    <span class="error col-md-12 no-padding"></span>
                                    <div class="progress" id="progressBar" style="margin: 5px 0 0 0; display: none;">
                                      <div class="progress-bar progress-bar-success progress-bar-striped active" style="width: 100%"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9 col-sm-10 col-xs-10">
                                    <input class="form-control" name="q3" placeholder="Name of exam" required="" type="text" value="<?php echo $getStudentMarks->getQuiz3(); ?>" readonly>
                                    <span class="error col-md-12 no-padding"></span>
                                    <div class="progress" id="progressBar" style="margin: 5px 0 0 0; display: none;">
                                      <div class="progress-bar progress-bar-success progress-bar-striped active" style="width: 100%"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9 col-sm-10 col-xs-10">
                                    <input class="form-control" name="final" placeholder="Name of exam" required="" type="text" value="<?php echo $getStudentMarks->getFinal_exam(); ?>" readonly>
                                    <span class="error col-md-12 no-padding"></span>
                                    <div class="progress" id="progressBar" style="margin: 5px 0 0 0; display: none;">
                                      <div class="progress-bar progress-bar-success progress-bar-striped active" style="width: 100%"></div>
                                    </div>
