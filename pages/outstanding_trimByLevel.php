...
if (isset($_GET['rank_id'])) 
    ...
    $objPHPExcel = $objReader->load("templates/outstanding_trimByLevel.xls");
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('I10', $rank->getYear());
...
//    $objPHPExcel->getActiveSheet()->removeRow($baseRow - 1, 1);
    ...
    $filename = "outstanding_trimByLevel.xls";
    $file_path = "http://" . $_SERVER['HTTP_HOST'] . "/rachana/pages/" . $filename;
//      var_dump($file_path);
    $contenttype = "application/octet-stream";
    header("Content-Type: " . $contenttype);
    header("Content-Disposition: attachment; filename=\"" . basename("outstanding_trimByLevel-" . $selectMonth . ".xls") . "\";");
