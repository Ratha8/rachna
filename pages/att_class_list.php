                    ...
                    <table id="class-list" class="table table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <tr class="center text-nowrap">
                         ...
                         <td>
                            <a class="btn btn-info" href="att_register.php?id=<?php echo $id; ?>" 
                              role="button" data-toggle="tooltip" title="Insert Student Attendance">
                              <i class="fa fa-check-square-o"></i>
                            </a> 
                              <a class="btn btn-primary" href="att_view.php?id=<?php echo $id; ?>" 
                              role="button" data-toggle="tooltip" title="View Student Attendance">
