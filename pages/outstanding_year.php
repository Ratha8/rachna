...
if (isset($_GET['rank_id'])) 
    ...
    $objPHPExcel = $objReader->load("templates/outstanding_year.xls");
...
//    $objPHPExcel->getActiveSheet()->removeRow($baseRow - 1, 1);
    ...
    $filename = "outstanding_year.xls";
    $file_path = "http://" . $_SERVER['HTTP_HOST'] . "/rachana/pages/" . $filename;
//      var_dump($file_path);
    $contenttype = "application/octet-stream";
    header("Content-Type: " . $contenttype);
    header("Content-Disposition: attachment; filename=\"" . basename("outstanding_year-" . $rank->getYear() . ".xls") . "\";");
