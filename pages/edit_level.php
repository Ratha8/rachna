<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $level = new Level;
    $level->setLevelID($_POST['level_id']);
    $level->setUpdateUser($user_session->getUserID());
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>Update the level of study information</small>
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'] . "?id=" . $form->getLevelID(); ?>" method="POST" id="levelForm">
                  <div class="box-body">
                    <input type="hidden" name="level_id" value="<?php echo $form->getLevelID(); ?>">
                    <div class="form-group level">
                      <label class="col-md-1 col-sm-2 col-xs-2 control-label">Name</label>
                      <div class="col-md-5 col-sm-10 col-xs-10">
                        <div class="input-group">
                          <input type="text" class="form-control" name="level_name" placeholder="Level Name" value="<?php echo $form->getLevelName(); ?>">
