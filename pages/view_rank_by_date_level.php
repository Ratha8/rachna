...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            View All Records
            <small>Outstanding Students By Level</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xs-6">
                ...
                <div class="small-box bg-blue class-box">
                    ...
                    <a href="view_rank_level.php?rank_id=<?php echo $rank_id ?>" class="small-box-footer">
                        View Records
            ...
            <div class="col-lg-4 col-xs-6">
                ...
                <div class="small-box bg-blue class-box">
                    ...
                    <a href="view_rank_trim_level.php?rank_id=<?php echo $rank_id ?>" class="small-box-footer">
                        View Records
            ...
            <div class="col-lg-4 col-xs-6">
                ...
                <div class="small-box bg-blue class-box">
                    ...
                    <a href="view_rank_sem_level.php?rank_id=<?php echo $rank_id ?>" class="small-box-footer">
                        View Records
            ...
            <div class="col-lg-4 col-xs-6">
                ...
                <div class="small-box bg-blue class-box">
                    ...
                    <a href="view_rank_1y_level.php?rank_id=<?php echo $rank_id ?>" class="small-box-footer">
                        View Records
