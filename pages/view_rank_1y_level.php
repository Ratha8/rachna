            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-header">
                        ...
                        <a role="button" href="outstanding_YearByLevel.php?rank_id=<?php echo $rank_id ; ?>&year=<?php echo $rank->getYear() ?>" class="btn btn-success btn-icon"
                                            ...
                                            foreach ($levels as $key => $value) {
                                                ...
                                                if(empty($classByLevel)){
                                                    ...
                                                    foreach ($getTrimExamScore as $number => $record) {
                                                        ...
                                                        echo '<td>
                                                            <a class="btn btn-link btn-icon" href="certi_register_outstanding.php?id='.$student->getStudentID().'&level='.$levels[$key]['level_id'].'&score='.$totalAll.'&duration=1&year='.$rank->getYear().'&type=4" role="button" 
