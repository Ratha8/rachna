  <?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $student->setFee($fee);
      $student->setExpirePaymentDate($expire_new);
      ...
      if($st_err === 0){
        ...
        header("Location:paid_unpaid_view.php?id=" . $_POST['room_id']);
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"> Making Payment</li>
            </ol>
          </section>

          <!-- Main content -->
          <section class="content">
            <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'] .'?id=' . $student->getStudentID() .'&room='. $classID; ?>" method="POST" id="paymentForm">
              <!-- Horizontal Form -->
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="box box-info">
                    <div class="box-header with-border">
                      ...
                      <input type="hidden" name="room_id" value="<?php echo $classID; ?>">
                    </div>
                    <div class="box-body"> 
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-10 col-xs-10"> 
                               <input class="form-control" name="invoice_number" placeholder="Invoice Number">
                               <span class="error col-md-12 no-padding"><?php echo $invoice_number_err;?></span>
                            </div>
                            <label class="col-md-4 col-sm-3 col-xs-3 control-label">Pay for</label>
                            <div class="col-md-8 col-sm-9 col-xs-9 select">
                            ...
                            <div class="col-md-8 col-sm-9 col-xs-9 datetime-plus">
                              <div class='input-group date'>
                                <input type='text' name="start_new" id="start" class="form-control" placeholder="Start Date" readonly value="<?php 
                                $show = getAllStudentInvoices($id);
                                if(!empty($show)){
                                  echo dateFormat($student->getExpirePaymentDate(), 'd/F/Y'); 
                                }else{
                                  echo dateFormat($student->getEnrollDate(), 'd/F/Y');
                                }
                                ?>">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="col-md-4 col-sm-2 col-xs-2 control-label">Payment Date</label>
                            <div class="col-md-8 col-sm-10 col-xs-10"> 
                              <div class='input-group date'>
                            ...
                            <label class="col-md-4 col-sm-2 col-xs-2 control-label">Paid Fee</label>
                            <div class="col-md-8 col-sm-10 col-xs-10">
                              <input class="form-control" name="fee" placeholder="Payment Fee">
                              <span class="error col-md-12 no-padding"><?php echo $fee_err;?></span>
                            </div>   
                            <label class="col-md-4 col-sm-2 col-xs-2 control-label"> Expire</label>
                            <div class="col-md-8 col-sm-10 col-xs-10 datetime-plus">
                              <div class='input-group date'>
                                <input type='text' name="expire_new" id="expire" class="form-control" placeholder="Expire Date" readonly='readonly' 
                                                         value="">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                              </div>
                            </div>
