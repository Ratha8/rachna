                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="col-md-3 col-sm-2 col-xs-2 control-label">Pay for</label>
                          <div class="col-md-9 col-sm-10 col-xs-10 select">
                          ...
                          <label class="col-md-3 col-sm-2 col-xs-2 control-label">Start Date</label>
                                        <div class="col-md-9 col-sm-10 col-xs-10 datetime-plus">
                                            <div class='input-group date'>
                                                <input type='text' name="start_new" id="start" class="form-control" placeholder="Start Date" readonly  value=" <?php echo dateFormat($student->getPaymentDate(),'d/F/Y');?>">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="col-md-3 col-sm-2 col-xs-2 control-label">Paid Fee</label>
                          ...
                          <label class="col-md-3 col-sm-2 col-xs-2 control-label"> Expire</label>
                                        <div class="col-md-9 col-sm-10 col-xs-10 datetime-plus">
                                            <div class='input-group date'>
                                                <input type='text' name="expire_new" id="expire" class="form-control" placeholder="Expire Date" readonly 
                                                      value="<?php echo dateFormat($student->getExpire_new(), 'd/F/Y'); ?>"  
                                                >
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
